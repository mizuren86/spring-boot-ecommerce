...
import com.luv2code.ecommerce.member.repository.UserRepository;
import com.luv2code.ecommerce.member.repository.UserVipHistoryRepository;
import com.luv2code.ecommerce.member.repository.UserVipRepository;
...
public class UserService {
    ...
    // 創建帶VIP信息的用戶
    @Transactional
    public User createUserWithVip(UserDTO userDTO, UserVipDTO vipDTO) {
        // 1. 創建用戶
        ...
        for (User user : users) {
            ...
            try {
                ...
                if (currentPassword.startsWith("$2a$")) {
                    ...
                    resetPassword(user.getMemberId(), currentPassword);
